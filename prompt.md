...
Além do relatório textual, gere uma saída estruturada em JSON com o seguinte formato:
...
5. Gere uma auditoria individual por processo, salvo se o usuário pedir comparação.
6. Se houver múltiplos processos, crie primeiro um índice de processos e peça ou selecione o mais relevante conforme critério objetivo.
7. O processo mais relevante normalmente será aquele:
...
8. Não audite processo sem documentos mínimos, salvo se a tarefa for triagem preliminar.
